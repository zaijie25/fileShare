    ...
    italk.pb = (function() {
        ...
        pb.ItalkEchoInfo = (function() {
            ...
            ItalkEchoInfo.decode = function decode(reader, length) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkEchoInfo();
            ...
            ItalkEchoInfo.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkEchoInfo)
                    return object;
            ...
            ItalkEchoInfo.toObject = function toObject(message, options) {
                ...
                if (message.type != null && message.hasOwnProperty("type"))
                    object.type = options.enums === String ? $root.italk.pb.ItalkTypeEnum[message.type] : message.type;
                if (message.error != null && message.hasOwnProperty("error"))
                    object.error = options.enums === String ? $root.italk.pb.ItalkErrorEnum[message.error] : message.error;
                if (message.Info != null && message.hasOwnProperty("Info"))
        ...
        pb.ItalkHeartMsg = (function() {
            ...
            ItalkHeartMsg.encode = function encode(message, writer) {
                ...
                if (message.heartCount != null && message.hasOwnProperty("heartCount"))
                    writer.uint32(/* id 2, wireType 0 =*/16).uint64(message.heartCount);
                ...
                if (message.serverInfo != null && message.hasOwnProperty("serverInfo"))
                    writer.uint32(/* id 5, wireType 2 =*/42).string(message.serverInfo);
            ...
            ItalkHeartMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkHeartMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkHeartMsg.verify = function verify(message) {
                ...
                if (message.heartCount != null && message.hasOwnProperty("heartCount"))
                    if (!$util.isInteger(message.heartCount) && !(message.heartCount && $util.isInteger(message.heartCount.low) && $util.isInteger(message.heartCount.high)))
                        return "heartCount: integer|Long expected";
                if (message.number != null && message.hasOwnProperty("number"))
            ...
            ItalkHeartMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkHeartMsg)
                    return object;
                ...
                if (object.heartCount != null)
                    if ($util.Long)
                        (message.heartCount = $util.Long.fromValue(object.heartCount)).unsigned = true;
                    else if (typeof object.heartCount === "string")
                        message.heartCount = parseInt(object.heartCount, 10);
                    else if (typeof object.heartCount === "number")
                        message.heartCount = object.heartCount;
                    else if (typeof object.heartCount === "object")
                        message.heartCount = new $util.LongBits(object.heartCount.low >>> 0, object.heartCount.high >>> 0).toNumber(true);
            ...
            ItalkHeartMsg.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        ...
                        object.heartCount = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.heartCount = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, true);
                ...
                if (message.msgType != null && message.hasOwnProperty("msgType"))
                    object.msgType = options.enums === String ? $root.italk.pb.ItalkTypeEnum[message.msgType] : message.msgType;
                if (message.heartCount != null && message.hasOwnProperty("heartCount"))
                    if (typeof message.heartCount === "number")
                        object.heartCount = options.longs === String ? String(message.heartCount) : message.heartCount;
                    else
                        object.heartCount = options.longs === String ? $util.Long.prototype.toString.call(message.heartCount) : options.longs === Number ? new $util.LongBits(message.heartCount.low >>> 0, message.heartCount.high >>> 0).toNumber(true) : message.heartCount;
                if (message.number != null && message.hasOwnProperty("number"))
        ...
        pb.ItalkHeartEchoMsg = (function() {
            ...
            ItalkHeartEchoMsg.encode = function encode(message, writer) {
                ...
                if (message.echoInfo != null && message.hasOwnProperty("echoInfo"))
                    $root.italk.pb.ItalkEchoInfo.encode(message.echoInfo, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.heartCount != null && message.hasOwnProperty("heartCount"))
                    writer.uint32(/* id 3, wireType 0 =*/24).uint64(message.heartCount);
                if (message.number != null && message.hasOwnProperty("number"))
                    writer.uint32(/* id 4, wireType 0 =*/32).uint64(message.number);
                return writer;
            };
            ...
            ItalkHeartEchoMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkHeartEchoMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkHeartEchoMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkHeartEchoMsg)
                    return object;
                ...
                if (object.echoInfo != null) {
                    if (typeof object.echoInfo !== "object")
                        throw TypeError(".italk.pb.ItalkHeartEchoMsg.echoInfo: object expected");
            ...
            ItalkHeartEchoMsg.toObject = function toObject(message, options) {
                ...
                if (message.msgType != null && message.hasOwnProperty("msgType"))
                    object.msgType = options.enums === String ? $root.italk.pb.ItalkTypeEnum[message.msgType] : message.msgType;
                if (message.echoInfo != null && message.hasOwnProperty("echoInfo"))
                    object.echoInfo = $root.italk.pb.ItalkEchoInfo.toObject(message.echoInfo, options);
                if (message.heartCount != null && message.hasOwnProperty("heartCount"))
                    if (typeof message.heartCount === "number")
                        object.heartCount = options.longs === String ? String(message.heartCount) : message.heartCount;
                    else
        ...
        pb.ItalkMsgContent = (function() {
            ...
            ItalkMsgContent.encode = function encode(message, writer) {
                ...
                if (message.imageformat != null && message.hasOwnProperty("imageformat"))
                    writer.uint32(/* id 3, wireType 0 =*/24).int32(message.imageformat);
                ...
                if (message.second != null && message.hasOwnProperty("second"))
                    writer.uint32(/* id 8, wireType 0 =*/64).int32(message.second);
                if (message.filename != null && message.hasOwnProperty("filename"))
                    writer.uint32(/* id 9, wireType 2 =*/74).string(message.filename);
                if (message.desc != null && message.hasOwnProperty("desc"))
                    writer.uint32(/* id 10, wireType 2 =*/82).string(message.desc);
                if (message.latitude != null && message.hasOwnProperty("latitude"))
                    writer.uint32(/* id 11, wireType 2 =*/90).string(message.latitude);
                if (message.longitude != null && message.hasOwnProperty("longitude"))
                    writer.uint32(/* id 12, wireType 2 =*/98).string(message.longitude);
                return writer;
            };
            ...
            ItalkMsgContent.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkMsgContent();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkMsgContent.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkMsgContent)
                    return object;
            ...
            ItalkMsgContent.toObject = function toObject(message, options) {
                ...
                if (message.imageformat != null && message.hasOwnProperty("imageformat"))
                    object.imageformat = options.enums === String ? $root.italk.pb.ItalkFormatTypeEnum[message.imageformat] : message.imageformat;
                if (message.width != null && message.hasOwnProperty("width"))
        ...
        pb.ItalkRecordMsg = (function() {
            ...
            ItalkRecordMsg.encode = function encode(message, writer) {
                ...
                if (message.recordMsg != null && message.hasOwnProperty("recordMsg"))
                    $root.italk.pb.ItalkRecordMsg.encode(message.recordMsg, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                if (message.level != null && message.hasOwnProperty("level"))
                    writer.uint32(/* id 2, wireType 0 =*/16).int32(message.level);
                if (message.CurCount != null && message.hasOwnProperty("CurCount"))
                    writer.uint32(/* id 3, wireType 0 =*/24).int32(message.CurCount);
                if (message.chatMsgList != null && message.chatMsgList.length)
                    for (var i = 0; i < message.chatMsgList.length; ++i)
                        $root.italk.pb.ItalkChatMsg.encode(message.chatMsgList[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                if (message.briefInfo != null && message.briefInfo.length)
                    for (var i = 0; i < message.briefInfo.length; ++i)
                        writer.uint32(/* id 6, wireType 2 =*/50).string(message.briefInfo[i]);
                return writer;
            };
            ...
            ItalkRecordMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkRecordMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkRecordMsg.verify = function verify(message) {
                ...
                if (message.recordMsg != null && message.hasOwnProperty("recordMsg")) {
                    ...
                    if (error)
                        return "recordMsg." + error;
                }
                if (message.level != null && message.hasOwnProperty("level"))
                    if (!$util.isInteger(message.level))
                        return "level: integer expected";
                if (message.CurCount != null && message.hasOwnProperty("CurCount"))
                    if (!$util.isInteger(message.CurCount))
                        return "CurCount: integer expected";
                if (message.chatMsgList != null && message.hasOwnProperty("chatMsgList")) {
                    if (!Array.isArray(message.chatMsgList))
                        return "chatMsgList: array expected";
                    for (var i = 0; i < message.chatMsgList.length; ++i) {
                        var error = $root.italk.pb.ItalkChatMsg.verify(message.chatMsgList[i]);
                        if (error)
                            return "chatMsgList." + error;
                    }
                }
                if (message.briefInfo != null && message.hasOwnProperty("briefInfo")) {
                    if (!Array.isArray(message.briefInfo))
                        return "briefInfo: array expected";
                    for (var i = 0; i < message.briefInfo.length; ++i)
                        if (!$util.isString(message.briefInfo[i]))
                            return "briefInfo: string[] expected";
                }
                return null;
            };
            ...
            ItalkRecordMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkRecordMsg)
                    return object;
                var message = new $root.italk.pb.ItalkRecordMsg();
                if (object.recordMsg != null) {
                    if (typeof object.recordMsg !== "object")
                        throw TypeError(".italk.pb.ItalkRecordMsg.recordMsg: object expected");
                    message.recordMsg = $root.italk.pb.ItalkRecordMsg.fromObject(object.recordMsg);
                }
                if (object.level != null)
                    message.level = object.level | 0;
                if (object.CurCount != null)
                    message.CurCount = object.CurCount | 0;
                if (object.chatMsgList) {
                    if (!Array.isArray(object.chatMsgList))
                        throw TypeError(".italk.pb.ItalkRecordMsg.chatMsgList: array expected");
                    message.chatMsgList = [];
                    for (var i = 0; i < object.chatMsgList.length; ++i) {
                        if (typeof object.chatMsgList[i] !== "object")
                            throw TypeError(".italk.pb.ItalkRecordMsg.chatMsgList: object expected");
                        message.chatMsgList[i] = $root.italk.pb.ItalkChatMsg.fromObject(object.chatMsgList[i]);
                    }
                }
                if (object.briefInfo) {
                    if (!Array.isArray(object.briefInfo))
                        throw TypeError(".italk.pb.ItalkRecordMsg.briefInfo: array expected");
                    message.briefInfo = [];
            ...
            ItalkRecordMsg.toObject = function toObject(message, options) {
                ...
                if (message.recordMsg != null && message.hasOwnProperty("recordMsg"))
                    object.recordMsg = $root.italk.pb.ItalkRecordMsg.toObject(message.recordMsg, options);
                if (message.level != null && message.hasOwnProperty("level"))
                    object.level = message.level;
                if (message.CurCount != null && message.hasOwnProperty("CurCount"))
                    object.CurCount = message.CurCount;
                if (message.chatMsgList && message.chatMsgList.length) {
                    object.chatMsgList = [];
        ...
        pb.ItalkChatMsg = (function() {
            ...
            ItalkChatMsg.encode = function encode(message, writer) {
                ...
                if (message.fid != null && message.hasOwnProperty("fid"))
                    writer.uint32(/* id 4, wireType 2 =*/34).string(message.fid);
                if (message.memberids != null && message.memberids.length)
                    for (var i = 0; i < message.memberids.length; ++i)
                        writer.uint32(/* id 5, wireType 2 =*/42).string(message.memberids[i]);
                ...
                if (message.burnsecond != null && message.hasOwnProperty("burnsecond"))
                    writer.uint32(/* id 8, wireType 0 =*/64).int32(message.burnsecond);
                if (message.burn != null && message.hasOwnProperty("burn"))
                    writer.uint32(/* id 9, wireType 0 =*/72).bool(message.burn);
                if (message.chattype != null && message.hasOwnProperty("chattype"))
                    writer.uint32(/* id 10, wireType 0 =*/80).int32(message.chattype);
                if (message.bussinesstype != null && message.hasOwnProperty("bussinesstype"))
                    writer.uint32(/* id 11, wireType 0 =*/88).int32(message.bussinesstype);
                if (message.status != null && message.hasOwnProperty("status"))
                    writer.uint32(/* id 12, wireType 0 =*/96).int32(message.status);
                if (message.content != null && message.hasOwnProperty("content"))
                    $root.italk.pb.ItalkMsgContent.encode(message.content, writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
                if (message.userupdatetime != null && message.hasOwnProperty("userupdatetime"))
                    writer.uint32(/* id 14, wireType 0 =*/112).int64(message.userupdatetime);
                if (message.msgindex != null && message.hasOwnProperty("msgindex"))
                    writer.uint32(/* id 15, wireType 0 =*/120).int64(message.msgindex);
                if (message.msglastindex != null && message.hasOwnProperty("msglastindex"))
                    writer.uint32(/* id 16, wireType 0 =*/128).int64(message.msglastindex);
                if (message.online != null && message.hasOwnProperty("online"))
                    writer.uint32(/* id 17, wireType 0 =*/136).bool(message.online);
                if (message.offlinenum != null && message.hasOwnProperty("offlinenum"))
                    writer.uint32(/* id 18, wireType 0 =*/144).int64(message.offlinenum);
                if (message.msgorder != null && message.hasOwnProperty("msgorder"))
                    writer.uint32(/* id 19, wireType 0 =*/152).int64(message.msgorder);
                if (message.msguserorder != null && message.hasOwnProperty("msguserorder"))
                    writer.uint32(/* id 20, wireType 0 =*/160).int64(message.msguserorder);
                if (message.text1 != null && message.hasOwnProperty("text1"))
                    writer.uint32(/* id 21, wireType 2 =*/170).string(message.text1);
                if (message.text2 != null && message.hasOwnProperty("text2"))
                    writer.uint32(/* id 22, wireType 2 =*/178).string(message.text2);
                if (message.text3 != null && message.hasOwnProperty("text3"))
                    writer.uint32(/* id 23, wireType 2 =*/186).string(message.text3);
                if (message.groupupdatetime != null && message.hasOwnProperty("groupupdatetime"))
                    writer.uint32(/* id 24, wireType 0 =*/192).int64(message.groupupdatetime);
                if (message.msgflag != null && message.hasOwnProperty("msgflag"))
                    writer.uint32(/* id 25, wireType 0 =*/200).int64(message.msgflag);
                if (message.msginfo1 != null && message.hasOwnProperty("msginfo1"))
                    writer.uint32(/* id 26, wireType 2 =*/210).string(message.msginfo1);
                if (message.msgint1 != null && message.hasOwnProperty("msgint1"))
                    writer.uint32(/* id 27, wireType 0 =*/216).int64(message.msgint1);
                if (message.msginfo2 != null && message.hasOwnProperty("msginfo2"))
                    writer.uint32(/* id 28, wireType 2 =*/226).string(message.msginfo2);
                if (message.msgint2 != null && message.hasOwnProperty("msgint2"))
                    writer.uint32(/* id 29, wireType 0 =*/232).int64(message.msgint2);
                if (message.msginfo3 != null && message.hasOwnProperty("msginfo3"))
                    writer.uint32(/* id 30, wireType 2 =*/242).string(message.msginfo3);
                if (message.uuid != null && message.hasOwnProperty("uuid"))
                    writer.uint32(/* id 31, wireType 2 =*/250).string(message.uuid);
                if (message.crc != null && message.hasOwnProperty("crc"))
                    writer.uint32(/* id 32, wireType 0 =*/256).int64(message.crc);
                if (message.errorinfo != null && message.hasOwnProperty("errorinfo"))
                    writer.uint32(/* id 33, wireType 2 =*/266).string(message.errorinfo);
                if (message.number != null && message.hasOwnProperty("number"))
                    writer.uint32(/* id 34, wireType 0 =*/272).int64(message.number);
                ...
                if (message.records != null && message.hasOwnProperty("records"))
                    $root.italk.pb.ItalkRecordMsg.encode(message.records, writer.uint32(/* id 36, wireType 2 =*/290).fork()).ldelim();
                return writer;
            };
            ...
            ItalkChatMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkChatMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkChatMsg.verify = function verify(message) {
                ...
                if (message.burnsecond != null && message.hasOwnProperty("burnsecond"))
                    if (!$util.isInteger(message.burnsecond))
                        return "burnsecond: integer expected";
                if (message.burn != null && message.hasOwnProperty("burn"))
                    if (typeof message.burn !== "boolean")
                        return "burn: boolean expected";
                if (message.chattype != null && message.hasOwnProperty("chattype"))
                ...
                if (message.userupdatetime != null && message.hasOwnProperty("userupdatetime"))
                    if (!$util.isInteger(message.userupdatetime) && !(message.userupdatetime && $util.isInteger(message.userupdatetime.low) && $util.isInteger(message.userupdatetime.high)))
                        return "userupdatetime: integer|Long expected";
                if (message.msgindex != null && message.hasOwnProperty("msgindex"))
                    if (!$util.isInteger(message.msgindex) && !(message.msgindex && $util.isInteger(message.msgindex.low) && $util.isInteger(message.msgindex.high)))
                        return "msgindex: integer|Long expected";
                if (message.msglastindex != null && message.hasOwnProperty("msglastindex"))
                    if (!$util.isInteger(message.msglastindex) && !(message.msglastindex && $util.isInteger(message.msglastindex.low) && $util.isInteger(message.msglastindex.high)))
                        return "msglastindex: integer|Long expected";
                if (message.online != null && message.hasOwnProperty("online"))
                    if (typeof message.online !== "boolean")
                        return "online: boolean expected";
                if (message.offlinenum != null && message.hasOwnProperty("offlinenum"))
                    if (!$util.isInteger(message.offlinenum) && !(message.offlinenum && $util.isInteger(message.offlinenum.low) && $util.isInteger(message.offlinenum.high)))
                        return "offlinenum: integer|Long expected";
                if (message.msgorder != null && message.hasOwnProperty("msgorder"))
                    if (!$util.isInteger(message.msgorder) && !(message.msgorder && $util.isInteger(message.msgorder.low) && $util.isInteger(message.msgorder.high)))
                        return "msgorder: integer|Long expected";
                if (message.msguserorder != null && message.hasOwnProperty("msguserorder"))
                    if (!$util.isInteger(message.msguserorder) && !(message.msguserorder && $util.isInteger(message.msguserorder.low) && $util.isInteger(message.msguserorder.high)))
                        return "msguserorder: integer|Long expected";
                if (message.text1 != null && message.hasOwnProperty("text1"))
                    if (!$util.isString(message.text1))
                        return "text1: string expected";
                if (message.text2 != null && message.hasOwnProperty("text2"))
                    if (!$util.isString(message.text2))
                        return "text2: string expected";
                if (message.text3 != null && message.hasOwnProperty("text3"))
                    if (!$util.isString(message.text3))
                        return "text3: string expected";
                if (message.groupupdatetime != null && message.hasOwnProperty("groupupdatetime"))
                    if (!$util.isInteger(message.groupupdatetime) && !(message.groupupdatetime && $util.isInteger(message.groupupdatetime.low) && $util.isInteger(message.groupupdatetime.high)))
                        return "groupupdatetime: integer|Long expected";
                if (message.msgflag != null && message.hasOwnProperty("msgflag"))
                    if (!$util.isInteger(message.msgflag) && !(message.msgflag && $util.isInteger(message.msgflag.low) && $util.isInteger(message.msgflag.high)))
                        return "msgflag: integer|Long expected";
                if (message.msginfo1 != null && message.hasOwnProperty("msginfo1"))
                    if (!$util.isString(message.msginfo1))
                        return "msginfo1: string expected";
                if (message.msgint1 != null && message.hasOwnProperty("msgint1"))
                    if (!$util.isInteger(message.msgint1) && !(message.msgint1 && $util.isInteger(message.msgint1.low) && $util.isInteger(message.msgint1.high)))
                        return "msgint1: integer|Long expected";
                if (message.msginfo2 != null && message.hasOwnProperty("msginfo2"))
                    if (!$util.isString(message.msginfo2))
                        return "msginfo2: string expected";
                if (message.msgint2 != null && message.hasOwnProperty("msgint2"))
                    if (!$util.isInteger(message.msgint2) && !(message.msgint2 && $util.isInteger(message.msgint2.low) && $util.isInteger(message.msgint2.high)))
                        return "msgint2: integer|Long expected";
                if (message.msginfo3 != null && message.hasOwnProperty("msginfo3"))
                    if (!$util.isString(message.msginfo3))
                        return "msginfo3: string expected";
                if (message.uuid != null && message.hasOwnProperty("uuid"))
                    if (!$util.isString(message.uuid))
                        return "uuid: string expected";
                if (message.crc != null && message.hasOwnProperty("crc"))
                    if (!$util.isInteger(message.crc) && !(message.crc && $util.isInteger(message.crc.low) && $util.isInteger(message.crc.high)))
                ...
                if (message.msgidList != null && message.hasOwnProperty("msgidList")) {
                    if (!Array.isArray(message.msgidList))
                        return "msgidList: array expected";
                    for (var i = 0; i < message.msgidList.length; ++i)
                        if (!$util.isInteger(message.msgidList[i]) && !(message.msgidList[i] && $util.isInteger(message.msgidList[i].low) && $util.isInteger(message.msgidList[i].high)))
                            return "msgidList: integer|Long[] expected";
                }
                if (message.records != null && message.hasOwnProperty("records")) {
            ...
            ItalkChatMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkChatMsg)
                    return object;
                ...
                if (object.memberids) {
                    if (!Array.isArray(object.memberids))
                        throw TypeError(".italk.pb.ItalkChatMsg.memberids: array expected");
                    message.memberids = [];
                ...
                if (object.burnsecond != null)
                    message.burnsecond = object.burnsecond | 0;
                if (object.burn != null)
                ...
                if (object.content != null) {
                    if (typeof object.content !== "object")
                        throw TypeError(".italk.pb.ItalkChatMsg.content: object expected");
                    message.content = $root.italk.pb.ItalkMsgContent.fromObject(object.content);
                }
                if (object.userupdatetime != null)
                    if ($util.Long)
                        (message.userupdatetime = $util.Long.fromValue(object.userupdatetime)).unsigned = false;
                    else if (typeof object.userupdatetime === "string")
                        message.userupdatetime = parseInt(object.userupdatetime, 10);
                    else if (typeof object.userupdatetime === "number")
                        message.userupdatetime = object.userupdatetime;
                    else if (typeof object.userupdatetime === "object")
                        message.userupdatetime = new $util.LongBits(object.userupdatetime.low >>> 0, object.userupdatetime.high >>> 0).toNumber();
                if (object.msgindex != null)
                    if ($util.Long)
                        (message.msgindex = $util.Long.fromValue(object.msgindex)).unsigned = false;
                    else if (typeof object.msgindex === "string")
                        message.msgindex = parseInt(object.msgindex, 10);
                    else if (typeof object.msgindex === "number")
                        message.msgindex = object.msgindex;
                    else if (typeof object.msgindex === "object")
                        message.msgindex = new $util.LongBits(object.msgindex.low >>> 0, object.msgindex.high >>> 0).toNumber();
                if (object.msglastindex != null)
                    if ($util.Long)
                        (message.msglastindex = $util.Long.fromValue(object.msglastindex)).unsigned = false;
                    else if (typeof object.msglastindex === "string")
                        message.msglastindex = parseInt(object.msglastindex, 10);
                    else if (typeof object.msglastindex === "number")
                        message.msglastindex = object.msglastindex;
                    else if (typeof object.msglastindex === "object")
                        message.msglastindex = new $util.LongBits(object.msglastindex.low >>> 0, object.msglastindex.high >>> 0).toNumber();
                if (object.online != null)
                    message.online = Boolean(object.online);
                if (object.offlinenum != null)
                    if ($util.Long)
                        (message.offlinenum = $util.Long.fromValue(object.offlinenum)).unsigned = false;
                    else if (typeof object.offlinenum === "string")
                        message.offlinenum = parseInt(object.offlinenum, 10);
                    else if (typeof object.offlinenum === "number")
                        message.offlinenum = object.offlinenum;
                    else if (typeof object.offlinenum === "object")
                        message.offlinenum = new $util.LongBits(object.offlinenum.low >>> 0, object.offlinenum.high >>> 0).toNumber();
                if (object.msgorder != null)
                    if ($util.Long)
                        (message.msgorder = $util.Long.fromValue(object.msgorder)).unsigned = false;
                    else if (typeof object.msgorder === "string")
                        message.msgorder = parseInt(object.msgorder, 10);
                    else if (typeof object.msgorder === "number")
                        message.msgorder = object.msgorder;
                    else if (typeof object.msgorder === "object")
                        message.msgorder = new $util.LongBits(object.msgorder.low >>> 0, object.msgorder.high >>> 0).toNumber();
                if (object.msguserorder != null)
                    if ($util.Long)
                        (message.msguserorder = $util.Long.fromValue(object.msguserorder)).unsigned = false;
                    else if (typeof object.msguserorder === "string")
                        message.msguserorder = parseInt(object.msguserorder, 10);
                    else if (typeof object.msguserorder === "number")
                        message.msguserorder = object.msguserorder;
                    else if (typeof object.msguserorder === "object")
                        message.msguserorder = new $util.LongBits(object.msguserorder.low >>> 0, object.msguserorder.high >>> 0).toNumber();
                if (object.text1 != null)
                    message.text1 = String(object.text1);
                if (object.text2 != null)
                    message.text2 = String(object.text2);
                if (object.text3 != null)
                    message.text3 = String(object.text3);
                if (object.groupupdatetime != null)
                    if ($util.Long)
                        (message.groupupdatetime = $util.Long.fromValue(object.groupupdatetime)).unsigned = false;
                    else if (typeof object.groupupdatetime === "string")
                        message.groupupdatetime = parseInt(object.groupupdatetime, 10);
                    else if (typeof object.groupupdatetime === "number")
                        message.groupupdatetime = object.groupupdatetime;
                    else if (typeof object.groupupdatetime === "object")
                        message.groupupdatetime = new $util.LongBits(object.groupupdatetime.low >>> 0, object.groupupdatetime.high >>> 0).toNumber();
                if (object.msgflag != null)
                    if ($util.Long)
                        (message.msgflag = $util.Long.fromValue(object.msgflag)).unsigned = false;
                    else if (typeof object.msgflag === "string")
                        message.msgflag = parseInt(object.msgflag, 10);
                    else if (typeof object.msgflag === "number")
                        message.msgflag = object.msgflag;
                    else if (typeof object.msgflag === "object")
                        message.msgflag = new $util.LongBits(object.msgflag.low >>> 0, object.msgflag.high >>> 0).toNumber();
                if (object.msginfo1 != null)
                    message.msginfo1 = String(object.msginfo1);
                if (object.msgint1 != null)
                    if ($util.Long)
                        (message.msgint1 = $util.Long.fromValue(object.msgint1)).unsigned = false;
                    else if (typeof object.msgint1 === "string")
                        message.msgint1 = parseInt(object.msgint1, 10);
                    else if (typeof object.msgint1 === "number")
                        message.msgint1 = object.msgint1;
                    else if (typeof object.msgint1 === "object")
                        message.msgint1 = new $util.LongBits(object.msgint1.low >>> 0, object.msgint1.high >>> 0).toNumber();
                if (object.msginfo2 != null)
                    message.msginfo2 = String(object.msginfo2);
                if (object.msgint2 != null)
                    if ($util.Long)
                        (message.msgint2 = $util.Long.fromValue(object.msgint2)).unsigned = false;
                    else if (typeof object.msgint2 === "string")
                        message.msgint2 = parseInt(object.msgint2, 10);
                    else if (typeof object.msgint2 === "number")
                        message.msgint2 = object.msgint2;
                    else if (typeof object.msgint2 === "object")
                        message.msgint2 = new $util.LongBits(object.msgint2.low >>> 0, object.msgint2.high >>> 0).toNumber();
                if (object.msginfo3 != null)
                    message.msginfo3 = String(object.msginfo3);
                if (object.uuid != null)
                    message.uuid = String(object.uuid);
                if (object.crc != null)
                    if ($util.Long)
                        (message.crc = $util.Long.fromValue(object.crc)).unsigned = false;
                    else if (typeof object.crc === "string")
                        message.crc = parseInt(object.crc, 10);
                    else if (typeof object.crc === "number")
                        message.crc = object.crc;
                    else if (typeof object.crc === "object")
                        message.crc = new $util.LongBits(object.crc.low >>> 0, object.crc.high >>> 0).toNumber();
                ...
                if (object.msgidList) {
                    if (!Array.isArray(object.msgidList))
                        throw TypeError(".italk.pb.ItalkChatMsg.msgidList: array expected");
                    message.msgidList = [];
                    for (var i = 0; i < object.msgidList.length; ++i)
                        if ($util.Long)
                            (message.msgidList[i] = $util.Long.fromValue(object.msgidList[i])).unsigned = false;
                        else if (typeof object.msgidList[i] === "string")
                            message.msgidList[i] = parseInt(object.msgidList[i], 10);
                        else if (typeof object.msgidList[i] === "number")
                            message.msgidList[i] = object.msgidList[i];
                        else if (typeof object.msgidList[i] === "object")
                            message.msgidList[i] = new $util.LongBits(object.msgidList[i].low >>> 0, object.msgidList[i].high >>> 0).toNumber();
                }
                if (object.records != null) {
                    if (typeof object.records !== "object")
                        throw TypeError(".italk.pb.ItalkChatMsg.records: object expected");
            ...
            ItalkChatMsg.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.userupdatetime = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.userupdatetime = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.msgindex = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.msgindex = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.msglastindex = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.msglastindex = options.longs === String ? "0" : 0;
                    object.online = false;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.offlinenum = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.offlinenum = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.msgorder = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.msgorder = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.msguserorder = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.msguserorder = options.longs === String ? "0" : 0;
                    object.text1 = "";
                    object.text2 = "";
                    object.text3 = "";
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.groupupdatetime = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.groupupdatetime = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.msgflag = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.msgflag = options.longs === String ? "0" : 0;
                    object.msginfo1 = "";
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.msgint1 = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.msgint1 = options.longs === String ? "0" : 0;
                    object.msginfo2 = "";
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.msgint2 = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.msgint2 = options.longs === String ? "0" : 0;
                    object.msginfo3 = "";
                    object.uuid = "";
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.crc = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.crc = options.longs === String ? "0" : 0;
                    object.errorinfo = "";
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.number = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                ...
                if (message.burnsecond != null && message.hasOwnProperty("burnsecond"))
                    object.burnsecond = message.burnsecond;
                if (message.burn != null && message.hasOwnProperty("burn"))
                    object.burn = message.burn;
                if (message.chattype != null && message.hasOwnProperty("chattype"))
                    object.chattype = options.enums === String ? $root.italk.pb.ItalkChatTypeEnum[message.chattype] : message.chattype;
                if (message.bussinesstype != null && message.hasOwnProperty("bussinesstype"))
                    object.bussinesstype = options.enums === String ? $root.italk.pb.ItalkBusinessTypeEnum[message.bussinesstype] : message.bussinesstype;
                if (message.status != null && message.hasOwnProperty("status"))
                    object.status = options.enums === String ? $root.italk.pb.ItalkMsgStatusEnum[message.status] : message.status;
                if (message.content != null && message.hasOwnProperty("content"))
                    object.content = $root.italk.pb.ItalkMsgContent.toObject(message.content, options);
                if (message.userupdatetime != null && message.hasOwnProperty("userupdatetime"))
                    if (typeof message.userupdatetime === "number")
                        object.userupdatetime = options.longs === String ? String(message.userupdatetime) : message.userupdatetime;
                    else
                        object.userupdatetime = options.longs === String ? $util.Long.prototype.toString.call(message.userupdatetime) : options.longs === Number ? new $util.LongBits(message.userupdatetime.low >>> 0, message.userupdatetime.high >>> 0).toNumber() : message.userupdatetime;
                if (message.msgindex != null && message.hasOwnProperty("msgindex"))
                    if (typeof message.msgindex === "number")
                        object.msgindex = options.longs === String ? String(message.msgindex) : message.msgindex;
                    else
                        object.msgindex = options.longs === String ? $util.Long.prototype.toString.call(message.msgindex) : options.longs === Number ? new $util.LongBits(message.msgindex.low >>> 0, message.msgindex.high >>> 0).toNumber() : message.msgindex;
                if (message.msglastindex != null && message.hasOwnProperty("msglastindex"))
                    if (typeof message.msglastindex === "number")
                        object.msglastindex = options.longs === String ? String(message.msglastindex) : message.msglastindex;
                    else
                        object.msglastindex = options.longs === String ? $util.Long.prototype.toString.call(message.msglastindex) : options.longs === Number ? new $util.LongBits(message.msglastindex.low >>> 0, message.msglastindex.high >>> 0).toNumber() : message.msglastindex;
                if (message.online != null && message.hasOwnProperty("online"))
                    object.online = message.online;
                if (message.offlinenum != null && message.hasOwnProperty("offlinenum"))
                    if (typeof message.offlinenum === "number")
                        object.offlinenum = options.longs === String ? String(message.offlinenum) : message.offlinenum;
                    else
                        object.offlinenum = options.longs === String ? $util.Long.prototype.toString.call(message.offlinenum) : options.longs === Number ? new $util.LongBits(message.offlinenum.low >>> 0, message.offlinenum.high >>> 0).toNumber() : message.offlinenum;
                if (message.msgorder != null && message.hasOwnProperty("msgorder"))
                    if (typeof message.msgorder === "number")
                        object.msgorder = options.longs === String ? String(message.msgorder) : message.msgorder;
                    else
                        object.msgorder = options.longs === String ? $util.Long.prototype.toString.call(message.msgorder) : options.longs === Number ? new $util.LongBits(message.msgorder.low >>> 0, message.msgorder.high >>> 0).toNumber() : message.msgorder;
                if (message.msguserorder != null && message.hasOwnProperty("msguserorder"))
                    if (typeof message.msguserorder === "number")
                        object.msguserorder = options.longs === String ? String(message.msguserorder) : message.msguserorder;
                    else
                        object.msguserorder = options.longs === String ? $util.Long.prototype.toString.call(message.msguserorder) : options.longs === Number ? new $util.LongBits(message.msguserorder.low >>> 0, message.msguserorder.high >>> 0).toNumber() : message.msguserorder;
                if (message.text1 != null && message.hasOwnProperty("text1"))
                    object.text1 = message.text1;
                if (message.text2 != null && message.hasOwnProperty("text2"))
                    object.text2 = message.text2;
                if (message.text3 != null && message.hasOwnProperty("text3"))
                    object.text3 = message.text3;
                if (message.groupupdatetime != null && message.hasOwnProperty("groupupdatetime"))
                    if (typeof message.groupupdatetime === "number")
                        object.groupupdatetime = options.longs === String ? String(message.groupupdatetime) : message.groupupdatetime;
                    else
                        object.groupupdatetime = options.longs === String ? $util.Long.prototype.toString.call(message.groupupdatetime) : options.longs === Number ? new $util.LongBits(message.groupupdatetime.low >>> 0, message.groupupdatetime.high >>> 0).toNumber() : message.groupupdatetime;
                if (message.msgflag != null && message.hasOwnProperty("msgflag"))
                    if (typeof message.msgflag === "number")
                        object.msgflag = options.longs === String ? String(message.msgflag) : message.msgflag;
                    else
                        object.msgflag = options.longs === String ? $util.Long.prototype.toString.call(message.msgflag) : options.longs === Number ? new $util.LongBits(message.msgflag.low >>> 0, message.msgflag.high >>> 0).toNumber() : message.msgflag;
                if (message.msginfo1 != null && message.hasOwnProperty("msginfo1"))
                    object.msginfo1 = message.msginfo1;
                if (message.msgint1 != null && message.hasOwnProperty("msgint1"))
                    if (typeof message.msgint1 === "number")
                        object.msgint1 = options.longs === String ? String(message.msgint1) : message.msgint1;
                    else
                        object.msgint1 = options.longs === String ? $util.Long.prototype.toString.call(message.msgint1) : options.longs === Number ? new $util.LongBits(message.msgint1.low >>> 0, message.msgint1.high >>> 0).toNumber() : message.msgint1;
                if (message.msginfo2 != null && message.hasOwnProperty("msginfo2"))
                    object.msginfo2 = message.msginfo2;
                if (message.msgint2 != null && message.hasOwnProperty("msgint2"))
                    if (typeof message.msgint2 === "number")
                        object.msgint2 = options.longs === String ? String(message.msgint2) : message.msgint2;
                    else
                        object.msgint2 = options.longs === String ? $util.Long.prototype.toString.call(message.msgint2) : options.longs === Number ? new $util.LongBits(message.msgint2.low >>> 0, message.msgint2.high >>> 0).toNumber() : message.msgint2;
                if (message.msginfo3 != null && message.hasOwnProperty("msginfo3"))
                    object.msginfo3 = message.msginfo3;
                if (message.uuid != null && message.hasOwnProperty("uuid"))
                    object.uuid = message.uuid;
                if (message.crc != null && message.hasOwnProperty("crc"))
                    if (typeof message.crc === "number")
                        object.crc = options.longs === String ? String(message.crc) : message.crc;
                    else
                        object.crc = options.longs === String ? $util.Long.prototype.toString.call(message.crc) : options.longs === Number ? new $util.LongBits(message.crc.low >>> 0, message.crc.high >>> 0).toNumber() : message.crc;
                if (message.errorinfo != null && message.hasOwnProperty("errorinfo"))
                ...
                if (message.msgidList && message.msgidList.length) {
                    ...
                    for (var j = 0; j < message.msgidList.length; ++j)
                        if (typeof message.msgidList[j] === "number")
                            object.msgidList[j] = options.longs === String ? String(message.msgidList[j]) : message.msgidList[j];
                        else
                            object.msgidList[j] = options.longs === String ? $util.Long.prototype.toString.call(message.msgidList[j]) : options.longs === Number ? new $util.LongBits(message.msgidList[j].low >>> 0, message.msgidList[j].high >>> 0).toNumber() : message.msgidList[j];
                }
                if (message.records != null && message.hasOwnProperty("records"))
                    object.records = $root.italk.pb.ItalkRecordMsg.toObject(message.records, options);
                return object;
            };
        ...
        pb.ItalkChatEchoMsg = (function() {
            ...
            ItalkChatEchoMsg.encode = function encode(message, writer) {
                ...
                if (message.localid != null && message.hasOwnProperty("localid"))
                    writer.uint32(/* id 4, wireType 0 =*/32).int64(message.localid);
                if (message.fid != null && message.hasOwnProperty("fid"))
                    writer.uint32(/* id 5, wireType 2 =*/42).string(message.fid);
                if (message.msgid != null && message.hasOwnProperty("msgid"))
                    writer.uint32(/* id 6, wireType 0 =*/48).int64(message.msgid);
                if (message.timestamp != null && message.hasOwnProperty("timestamp"))
                    writer.uint32(/* id 7, wireType 0 =*/56).int64(message.timestamp);
                ...
                if (message.status != null && message.hasOwnProperty("status"))
                    writer.uint32(/* id 12, wireType 0 =*/96).int32(message.status);
                if (message.msgindex != null && message.hasOwnProperty("msgindex"))
                    writer.uint32(/* id 13, wireType 0 =*/104).int64(message.msgindex);
                if (message.msgorder != null && message.hasOwnProperty("msgorder"))
                    writer.uint32(/* id 14, wireType 0 =*/112).int64(message.msgorder);
                if (message.msguserorder != null && message.hasOwnProperty("msguserorder"))
                    writer.uint32(/* id 15, wireType 0 =*/120).int64(message.msguserorder);
                if (message.text1 != null && message.hasOwnProperty("text1"))
                    writer.uint32(/* id 16, wireType 2 =*/130).string(message.text1);
                if (message.text2 != null && message.hasOwnProperty("text2"))
                    writer.uint32(/* id 17, wireType 2 =*/138).string(message.text2);
                if (message.text3 != null && message.hasOwnProperty("text3"))
                    writer.uint32(/* id 18, wireType 2 =*/146).string(message.text3);
                if (message.uuid != null && message.hasOwnProperty("uuid"))
                    writer.uint32(/* id 19, wireType 2 =*/154).string(message.uuid);
                if (message.crc != null && message.hasOwnProperty("crc"))
                    writer.uint32(/* id 20, wireType 0 =*/160).int64(message.crc);
                if (message.number != null && message.hasOwnProperty("number"))
            ...
            ItalkChatEchoMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkChatEchoMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkChatEchoMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkChatEchoMsg)
                    return object;
                ...
                if (object.echoInfo != null) {
                    if (typeof object.echoInfo !== "object")
                        throw TypeError(".italk.pb.ItalkChatEchoMsg.echoInfo: object expected");
                    message.echoInfo = $root.italk.pb.ItalkEchoInfo.fromObject(object.echoInfo);
                }
                if (object.userid != null)
                    message.userid = String(object.userid);
        ...
        pb.ItalkLoginMsg = (function() {
            ...
            ItalkLoginMsg.encode = function encode(message, writer) {
                ...
                if (message.number != null && message.hasOwnProperty("number"))
                    writer.uint32(/* id 6, wireType 0 =*/48).int64(message.number);
                return writer;
            };
            ...
            ItalkLoginMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkLoginMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkLoginMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkLoginMsg)
                    return object;
        ...
        pb.ItalkLoginEchoMsg = (function() {
            ...
            ItalkLoginEchoMsg.encode = function encode(message, writer) {
                ...
                if (message.userno != null && message.hasOwnProperty("userno"))
                    writer.uint32(/* id 6, wireType 0 =*/48).int64(message.userno);
                if (message.number != null && message.hasOwnProperty("number"))
            ...
            ItalkLoginEchoMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkLoginEchoMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkLoginEchoMsg.verify = function verify(message) {
                ...
                if (message.token != null && message.hasOwnProperty("token"))
                    if (!$util.isString(message.token))
                        return "token: string expected";
                if (message.userno != null && message.hasOwnProperty("userno"))
                    if (!$util.isInteger(message.userno) && !(message.userno && $util.isInteger(message.userno.low) && $util.isInteger(message.userno.high)))
                        return "userno: integer|Long expected";
                if (message.number != null && message.hasOwnProperty("number"))
                    if (!$util.isInteger(message.number) && !(message.number && $util.isInteger(message.number.low) && $util.isInteger(message.number.high)))
                        return "number: integer|Long expected";
                return null;
            ...
            ItalkLoginEchoMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkLoginEchoMsg)
                    return object;
                ...
                if (object.echoInfo != null) {
                    if (typeof object.echoInfo !== "object")
                        throw TypeError(".italk.pb.ItalkLoginEchoMsg.echoInfo: object expected");
                    message.echoInfo = $root.italk.pb.ItalkEchoInfo.fromObject(object.echoInfo);
                }
                if (object.localid != null)
                    if ($util.Long)
                ...
                if (object.userno != null)
                    if ($util.Long)
                        (message.userno = $util.Long.fromValue(object.userno)).unsigned = false;
                    else if (typeof object.userno === "string")
                        message.userno = parseInt(object.userno, 10);
                    else if (typeof object.userno === "number")
                        message.userno = object.userno;
                    else if (typeof object.userno === "object")
                        message.userno = new $util.LongBits(object.userno.low >>> 0, object.userno.high >>> 0).toNumber();
                if (object.number != null)
                    if ($util.Long)
                        (message.number = $util.Long.fromValue(object.number)).unsigned = false;
                    else if (typeof object.number === "string")
            ...
            ItalkLoginEchoMsg.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.userno = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.userno = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, false);
                        object.number = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                ...
                if (message.token != null && message.hasOwnProperty("token"))
                    object.token = message.token;
                if (message.userno != null && message.hasOwnProperty("userno"))
                    if (typeof message.userno === "number")
                        object.userno = options.longs === String ? String(message.userno) : message.userno;
                    else
                        object.userno = options.longs === String ? $util.Long.prototype.toString.call(message.userno) : options.longs === Number ? new $util.LongBits(message.userno.low >>> 0, message.userno.high >>> 0).toNumber() : message.userno;
                if (message.number != null && message.hasOwnProperty("number"))
                    if (typeof message.number === "number")
                        object.number = options.longs === String ? String(message.number) : message.number;
                    else
        ...
        pb.ItalkCommonMsg = (function() {
            ...
            ItalkCommonMsg.encode = function encode(message, writer) {
                ...
                if (message.number != null && message.hasOwnProperty("number"))
                    writer.uint32(/* id 5, wireType 0 =*/40).int64(message.number);
                return writer;
            };
            ...
            ItalkCommonMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkCommonMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkCommonMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkCommonMsg)
                    return object;
        ...
        pb.ItalkCommonEchoMsg = (function() {
            ...
            ItalkCommonEchoMsg.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.italk.pb.ItalkCommonEchoMsg();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ItalkCommonEchoMsg.fromObject = function fromObject(object) {
                if (object instanceof $root.italk.pb.ItalkCommonEchoMsg)
                    return object;
                ...
                if (object.echoInfo != null) {
                    if (typeof object.echoInfo !== "object")
                        throw TypeError(".italk.pb.ItalkCommonEchoMsg.echoInfo: object expected");
                    message.echoInfo = $root.italk.pb.ItalkEchoInfo.fromObject(object.echoInfo);
                }
                if (object.localid != null)
                    if ($util.Long)
