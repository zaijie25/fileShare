...
//	{
        ...
        (function (puremvc) {
            ...
            var View = (function () {
                ...
                View.prototype.initializeNotifier = function(key){
        ...
        (function (puremvc) {
            ...
            var Controller = (function () {
                ...
                Controller.prototype.initializeNotifier = function(key){
                    this.multitonKey = key;
                }
                ...
                Controller.removeController = function removeController(key){
                    Controller.instanceMap[key] = null;
                }
        ...
        (function (puremvc) {
            ...
            var Model = (function () {
                ...
                Model.prototype.initializeNotifier = function(key){
                    this.multitonKey = key;
                }
        ...
        (function (puremvc) {
            ...
            var Notifier = (function () {
                ...
                Notifier.prototype.getFacade = function(){
                        if (!this.multitonKey) {
                            throw Error(Notifier.SINGLETON_MSG);
                        }
                ...
                Notifier.SINGLETON_MSG = "multitonKey for this Notifier not yet initialized!"
                return Notifier;
            })();
